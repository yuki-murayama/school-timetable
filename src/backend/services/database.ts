import type { GenerationSession, GenerationStep, TimetableData, TimetableStructure } from '../types'
...
export class DatabaseService {
  ...
  async getStepsForDay(sessionId: string, day: string): Promise<GenerationStep[]> {
    const result = await this.db
      .prepare(`
  ...
  async getAllSteps(sessionId: string): Promise<GenerationStep[]> {
    const result = await this.db
      .prepare(`
