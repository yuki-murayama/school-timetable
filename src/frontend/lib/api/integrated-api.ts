...
// API ベースURL統一 (type-safe-clientが/apiを追加するため空文字列)
const API_BASE = ''
...
export const schoolSettingsApi = {
  ...
  async getSettings(options?: TypeSafeApiOptions): Promise<EnhancedSchoolSettings> {
    return typeSafeApiClient.get(`${API_BASE}/settings`, EnhancedSchoolSettingsSchema, options)
  },
...
// 教師作成リクエスト（共有スキーマと完全統一）
const CreateTeacherRequestSchema_Integrated = CreateTeacherRequestSchema

// 教師更新リクエスト（部分更新対応）
const UpdateTeacherRequestSchema_Integrated = CreateTeacherRequestSchema_Integrated.partial()

// 教科作成リクエスト
const CreateSubjectRequestSchema_Integrated = z.object({
...
// 教科更新リクエスト（部分更新対応）
const UpdateSubjectRequestSchema_Integrated = CreateSubjectRequestSchema_Integrated.partial()
...
export const teachersApi = {
  ...
  async getTeachers(
    ...
    const endpoint = queryString ? `${API_BASE}/teachers?${queryString}` : `${API_BASE}/teachers`
  ...
  async getTeacher(id: string, options?: TypeSafeApiOptions): Promise<Teacher> {
    return typeSafeApiClient.get(`${API_BASE}/teachers/${id}`, TeacherSchema, options)
  },
   ...
   */
  async createTeacher(
    teacherData: z.infer<typeof CreateTeacherRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
  ): Promise<Teacher> {
    return typeSafeApiClient.post(
      `${API_BASE}/teachers`,
      teacherData,
      CreateTeacherRequestSchema_Integrated,
      TeacherSchema,
      options
    )
  },
  ...
  async updateTeacher(
    id: string,
    updateData: z.infer<typeof UpdateTeacherRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
  ): Promise<Teacher> {
    return typeSafeApiClient.put(
      `${API_BASE}/teachers/${id}`,
      updateData,
      UpdateTeacherRequestSchema_Integrated,
      TeacherSchema,
      options
    )
  },
  ...
  async deleteTeacher(
    ...
    return typeSafeApiClient.delete(`${API_BASE}/teachers/${id}`, DeleteResponseSchema, options)
  },
}
...
export const subjectsApi = {
  ...
  async getSubjects(
    ...
    const queryString = searchParams.toString()
    const endpoint = queryString ? `${API_BASE}/subjects?${queryString}` : `${API_BASE}/subjects`
  ...
  async getSubject(id: string, options?: TypeSafeApiOptions): Promise<Subject> {
    return typeSafeApiClient.get(`${API_BASE}/subjects/${id}`, SubjectSchema, options)
  },
   ...
   */
  async createSubject(
    subjectData: z.infer<typeof CreateSubjectRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
  ): Promise<Subject> {
    return typeSafeApiClient.post(
      `${API_BASE}/subjects`,
      subjectData,
      CreateSubjectRequestSchema_Integrated,
      SubjectSchema,
      options
    )
  },
  ...
  async updateSubject(
    id: string,
    updateData: z.infer<typeof UpdateSubjectRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
  ): Promise<Subject> {
    return typeSafeApiClient.put(
      `${API_BASE}/subjects/${id}`,
      updateData,
      UpdateSubjectRequestSchema_Integrated,
      SubjectSchema,
      options
    )
  },
  ...
  async deleteSubject(
    ...
    return typeSafeApiClient.delete(`${API_BASE}/subjects/${id}`, DeleteResponseSchema, options)
  },
}
...
// 教室作成リクエスト
const CreateClassroomRequestSchema_Integrated = z.object({
  name: z.string().min(1).max(100),
  type: z.enum([
    '普通教室',
    '理科室',
...
// 教室更新リクエスト（部分更新対応）
const UpdateClassroomRequestSchema_Integrated = CreateClassroomRequestSchema_Integrated.partial()
...
export const classroomsApi = {
  ...
  async getClassrooms(
    ...
    const endpoint = queryString
      ? `${API_BASE}/classrooms?${queryString}`
      : `${API_BASE}/classrooms`
  ...
  async getClassroom(id: string, options?: TypeSafeApiOptions): Promise<Classroom> {
    return typeSafeApiClient.get(`${API_BASE}/classrooms/${id}`, ClassroomSchema, options)
  },
  ...
  async createClassroom(
    classroomData: z.infer<typeof CreateClassroomRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
  ): Promise<Classroom> {
    return typeSafeApiClient.post(
      `${API_BASE}/classrooms`,
      classroomData,
      CreateClassroomRequestSchema_Integrated,
      ClassroomSchema,
      options
    )
  },
  ...
  async updateClassroom(
    id: string,
    updateData: z.infer<typeof UpdateClassroomRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
  ): Promise<Classroom> {
    return typeSafeApiClient.put(
      `${API_BASE}/classrooms/${id}`,
      updateData,
      UpdateClassroomRequestSchema_Integrated,
      ClassroomSchema,
      options
    )
  },
  ...
  async deleteClassroom(
    ...
    return typeSafeApiClient.delete(`${API_BASE}/classrooms/${id}`, DeleteResponseSchema, options)
  },
}
...
// 時間割生成リクエスト
const GenerateTimetableRequestSchema_Integrated = z.object({
...
// 時間割更新リクエスト（部分更新対応）
const UpdateTimetableRequestSchema_Integrated = z.object({
  slots: z
    .array(
      z.object({
        weekday: z.number().min(1).max(5),
...
export const timetablesApi = {
  ...
  async getTimetables(
    ...
    const queryString = searchParams.toString()
    const endpoint = queryString
      ? `${API_BASE}/timetables?${queryString}`
      : `${API_BASE}/timetables`
  ...
  async getTimetable(id: string, options?: TypeSafeApiOptions): Promise<Timetable> {
    return typeSafeApiClient.get(`${API_BASE}/timetables/${id}`, TimetableSchema, options)
  },
  ...
  async generateTimetable(
    generateData: z.infer<typeof GenerateTimetableRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
    ...
    return typeSafeApiClient.post(
      `${API_BASE}/timetables/generate`,
      generateData,
      GenerateTimetableRequestSchema_Integrated,
  ...
  async getTimetableGenerationStatus(
    ...
    return typeSafeApiClient.get(
      `${API_BASE}/timetables/generate/${jobId}`,
  ...
  async updateTimetable(
    id: string,
    updateData: z.infer<typeof UpdateTimetableRequestSchema_Integrated>,
    options?: TypeSafeApiOptions
  ): Promise<Timetable> {
    return typeSafeApiClient.put(
      `${API_BASE}/timetables/${id}`,
      updateData,
      UpdateTimetableRequestSchema_Integrated,
      TimetableSchema,
      options
    )
  },
  ...
  async deleteTimetable(
    ...
    return typeSafeApiClient.delete(`${API_BASE}/timetables/${id}`, DeleteResponseSchema, options)
  },
}
...
export const conditionsApi = {
  ...
  async getConditions(options?: TypeSafeApiOptions): Promise<ConditionsData> {
    return typeSafeApiClient.get(`${API_BASE}/conditions`, ConditionsSchema, options)
  },
...
// 型安全性の確保
export type IntegratedApiClient = typeof integratedApi
 ...
 */
export const withIntegratedApiErrorHandling = <T extends unknown[], R>(
 ...
 */
export const integratedApiKeys = {
  ...
  timetables: {
    ...
    generate: (
      data: z.infer<typeof GenerateTimetableRequestSchema_Integrated>
    ): QueryKeyWithParams<z.infer<typeof GenerateTimetableRequestSchema_Integrated>> =>
