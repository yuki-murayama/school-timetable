...
import { schoolApi, type SchoolSettings } from "../../lib/api"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => onSettingsUpdate({ ...settings, grade1Classes: Number.parseInt(e.target.value) || 0 })}
              disabled={isLoading}
            />
          </div>
          <div>
            ...
            <Input
              ...
              placeholder={isLoading ? "読み込み中..." : "クラス数を入力"}
              onChange={(e) => onSettingsUpdate({ ...settings, grade2Classes: Number.parseInt(e.target.value) || 0 })}
              disabled={isLoading}
            />
          </div>
          <div>
            ...
            <Input
              ...
              placeholder={isLoading ? "読み込み中..." : "クラス数を入力"}
              onChange={(e) => onSettingsUpdate({ ...settings, grade3Classes: Number.parseInt(e.target.value) || 0 })}
              disabled={isLoading}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => onSettingsUpdate({ ...settings, dailyPeriods: Number.parseInt(e.target.value) || 0 })}
              disabled={isLoading}
            />
          </div>
          <div>
            ...
            <Input
              ...
              placeholder={isLoading ? "読み込み中..." : "授業数を入力"}
              onChange={(e) => onSettingsUpdate({ ...settings, saturdayPeriods: Number.parseInt(e.target.value) || 0 })}
              disabled={isLoading}
            />
          </div>
        </div>
